 ...
 */
@SuppressLint("WrongCall") public abstract class TosAdapterView<T extends Adapter> extends ViewGroup {
	...
	class AdapterDataSetObserver extends DataSetObserver {
		...
		public void onChanged() {
			...
			// Detect the case where a cursor that was previously invalidated has been repopulated with new data.
			if (TosAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null && mOldItemCount == 0 && mItemCount > 0) {
