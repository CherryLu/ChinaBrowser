...
public class RadioView extends BaseView implements View.OnClickListener {
    ...
    Context mContext;
    public RadioView(Context context, ViewGroup parent) {
        mContext = context;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mVivew =inflater.inflate(R.layout.radio_item,parent,false);
        ...
        covers[0] = (ImageView) mVivew.findViewById(R.id.main_pic1);
        covers[1] = (ImageView) mVivew.findViewById(R.id.main_pic2);
        covers[2] = (ImageView) mVivew.findViewById(R.id.main_pic3);
        covers[3] = (ImageView) mVivew.findViewById(R.id.main_pic4);
        covers[4] = (ImageView) mVivew.findViewById(R.id.main_pic5);
        covers[5] = (ImageView) mVivew.findViewById(R.id.main_pic6);

        plays[0] = (ImageView) mVivew.findViewById(R.id.paly1);
        plays[1] = (ImageView) mVivew.findViewById(R.id.paly2);
        plays[2] = (ImageView) mVivew.findViewById(R.id.paly3);
        plays[3] = (ImageView) mVivew.findViewById(R.id.paly4);
        plays[4] = (ImageView) mVivew.findViewById(R.id.paly5);
        plays[5] = (ImageView) mVivew.findViewById(R.id.paly6);
        setLinten();
        names[0] = (TextView) mVivew.findViewById(R.id.name1);
        names[1] = (TextView) mVivew.findViewById(R.id.name2);
        names[2] = (TextView) mVivew.findViewById(R.id.name3);
        names[3] = (TextView) mVivew.findViewById(R.id.name4);
        names[4] = (TextView) mVivew.findViewById(R.id.name5);
        names[5] = (TextView) mVivew.findViewById(R.id.name6);
        ...
        title.setText(context.getText(R.string.radio_text));
    }
